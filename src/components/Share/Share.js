        ...
        <div id="button_share">
            <div className="share_buttons_wrap">
                <div className="socialShareButtonItem mobile_w">
                    <a id="whatsapp_mobile" data-action="share/whatsapp/share" target="_blank" title="whatsapp" rel="nofollow" href="whatsapp://send?text=https://www.bestdivision.com/blog/how-to-make-simple-rest-api-in-codeignter">
                ...
                <div className="socialShareButtonItem xl_w">
                    <a id="whatsapp_web" target="_blank" title="whatsapp" rel="nofollow" href="https://web.whatsapp.com/send?text=https://www.bestdivision.com/blog/how-to-make-simple-rest-api-in-codeignter">
                        <div className="socialItem">
                            <div className="socialItem_icon">
                                <WhatsappIcon/>
                            </div>
                ...
                <div className="socialShareButtonItem">
                    <a id="facebook" target="_blank" title="facebook" rel="nofollow" href="http://www.facebook.com/sharer.php?u=https://www.bestdivision.com/blog/how-to-make-simple-rest-api-in-codeignter">
                        <div className="socialItem">
                            <div className="socialItem_icon">
                            <FacebookIcon/>
                            </div>
                ...
                <div className="socialShareButtonItem">
                    <a id="twitter" target="_blank" title="twitter" rel="nofollow" href="https://twitter.com/share?url=https://www.bestdivision.com/blog/how-to-make-simple-rest-api-in-codeignter&amp;amp;text=Simple%20Share%20Buttons&amp;amp;hashtags=simplesharebuttons">
                        <div className="socialItem">
                            <div className="socialItem_icon">
                                <TwitterIcon/>
                            </div>
            ...
            <!--        </div>-- >
                ...
                <div className="socialShareButtonItem">
                    <a id="tumblr" target="_blank" rel="nofollow" href="http://www.tumblr.com/share/link?url=https://www.bestdivision.com/blog/how-to-make-simple-rest-api-in-codeigntertitle=How to make simple REST API in Codeignter.">
                        <div className="socialItem">
                            <div className="socialItem_icon">
                                <TumblrIcon/>
                            </div>
                ...
                {/* <!----> */}
                <div className="socialShareButtonItem">
                    <a id="reddit" href="http://reddit.com/submit?url=https://www.bestdivision.com/blog/how-to-make-simple-rest-api-in-codeignter&amp;amp;title=How to make simple REST API in Codeignter." target="_blank" rel="nofollow">
                        <div className="socialItem">
                            <div className="socialItem_icon">
                                <RedditIcon/>
                            </div>
                ...
                {/* < !----> */}
                <div className="socialShareButtonItem">
                    <a id="linkedin" title="linkedin" target="_blank" rel="nofollow" href="http://www.linkedin.com/shareArticle?mini=true&amp;amp;url=https://www.bestdivision.com/blog/how-to-make-simple-rest-api-in-codeignter">
                        <div className="socialItem">
                            <div className="socialItem_icon">
                               <LinkedinIcon/>
                            </div>
                ...
                <div className="socialShareButtonItem">
                    <a id="yahoo" title="yahoo" rel="nofollow" href="mailto:?Subject=How to make simple REST API in Codeignter.&amp;amp;Body=I%20saw%20this%20and%20thought%20of%20you!%20https://www.bestdivision.com/blog/how-to-make-simple-rest-api-in-codeignter">
                        <div className="socialItem">
                            <div className="socialItem_icon">
                               <YahooIcon />
                            </div>
                ...
                {/* < !----> */}
                <div className="socialShareButtonItem">
                    <a id="gmail" title="gmail" rel="nofollow" href="mailto:?Subject=How to make simple REST API in Codeignter.&amp;amp;Body=I%20saw%20this%20and%20thought%20of%20you!%20https://www.bestdivision.com/blog/how-to-make-simple-rest-api-in-codeignter">
                        <div className="socialItem">
                            <div className="socialItem_icon">
                                <GmailIcon />
                            </div>
                ...
                <div className="socialShareButtonItem">
                    <div className="socialItem">
                        ...
                        <input id="copy_url" type="hidden" value="https://www.bestdivision.com/blog/how-to-make-simple-rest-api-in-codeignter" />
