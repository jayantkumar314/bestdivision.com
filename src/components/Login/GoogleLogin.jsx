  ...
  return (
    <div>
      {/* <GoogleLoginButton
        ...
        render={(renderProps) => (
            <>
            <div style={{cursor:'pointer'}} onClick={renderProps.onClick} disabled={renderProps.disabled} id="google-login-button" className="social-login-buttons login_socialIcons">
