...
function Blogs() {
    const [blogs, updateBlogs] = useState(initialBlogs);
    const [mode, setMode] = useState('online')
    const [dropdown, setDropdown] = useState(false)
    const [open, setOpen] = useState(false);
    const [modalOpen, setModalOpen] = useState(false);

    const getBlogs = async (attributes) => {
    ...
    return (
        <>
            <Modal isOpen={modalOpen} setModalOpen={setModalOpen} modalClassName='share_modal' children={<Share/>} />
            <Header />
                            ...
                            <div className="col-xs-12 col-sm-12 col-md-8 col-lg-6">
                                                ...
                                                <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                    <form className="job-search p-3" autoComplete="off" action="/action_page.php">
                                                        <div className="input-group autocomplete">
                                                            <input id="search_blogs" className="search_input" type="text" name="search_blogs" placeholder="Search Blogs" value="" aria-label="Search" aria-describedby="basic-addon2" />
                                                            <button className="input-group-append">
                                                                <Svg className="search-svg-container" svg={`<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><title>Search</title><path d="M9.516 14.016q1.875 0 3.188-1.313t1.313-3.188-1.313-3.188-3.188-1.313-3.188 1.313-1.313 3.188 1.313 3.188 3.188 1.313zM15.516 14.016l4.969 4.969-1.5 1.5-4.969-4.969v-0.797l-0.281-0.281q-1.781 1.547-4.219 1.547-2.719 0-4.617-1.875t-1.898-4.594 1.898-4.617 4.617-1.898 4.594 1.898 1.875 4.617q0 0.984-0.469 2.227t-1.078 1.992l0.281 0.281h0.797z"></path></svg>`} />
                                                            </button>
                                                        </div>
                                                    </form>
                                                </div>
                                ...
                                <div id="all_blogs" className="card">
                                    {blogs && blogs.length > 0 &&
                                        blogs.map((key, value) => {
                                            return (<Post props={key} onClickShare={onClickShare} setModalOpen={setModalOpen} />);
                                        })
                                    }
                                </div>
                            </div>
                                        ...
                                        <div className="modal-body">
                                            <div id="button_share">
                                                <div className="share_buttons_wrap">
                                                    ...
                                                    <div className="socialShareButtonItem">
                                                        <a id="reddit" href="http://reddit.com/submit?url=https://www.bestdivision.com/blog/kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk&amp;title=kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk" target="_blank" rel="nofollow">
                                                            <div className="socialItem">
                                                                <div className="socialItem_icon">
                                                                    {/* <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 192 192" style=" fill:#000000;">
                                                                <g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal">
