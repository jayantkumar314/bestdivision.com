import React, { Component, Suspense, Fragment, useState, useEffect, useRef, useCallback } from 'react'
// import './Blogs.css'
...
import InnerSearchBar from 'components/SearchBars/InnerSearchBar'
...
function Blogs() {
    ...
    const [{ appSession }, dispatch] = useStateValue();
    ...
    //     }
    // }, [isBottom]);
    function setHelmetMetaData() {
        dispatch({
            type: 'HELMET_META_DATA'
        })
    }
    useEffect(() => {
        //window.scrollTo(0, 0)
    ...
    return (
        <section id="section_content" className="css-scope section_content" >
            ...
            {/* <HelmetMetaData title="All Blogs Search" description="Blogs Shared by your Batchmates and Seniors"/> */}
                ...
                <div className="container-fluid">
                    <div className="row clearfix">
                            ...
                            <div className="wrapper center-block">
                                <div className="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                    <div className="panel panel-default">
                                        ...
                                        <div id="collapse_ratings" className="panel-collapse in collapse" role="tabpanel" aria-labelledby="headingOne">
                                            <div className="panel-body">
                                                <div className="row lead">
                                                    <div id="hearts" className="starrr"><span className="glyphicon .glyphicon-star-empty glyphicon-star-empty"></span><span className="glyphicon .glyphicon-star-empty glyphicon-star-empty"></span><span className="glyphicon .glyphicon-star-empty glyphicon-star-empty"></span><span className="glyphicon .glyphicon-star-empty glyphicon-star-empty"></span><span className="glyphicon .glyphicon-star-empty glyphicon-star-empty"></span></div>
                                                            You gave a rating of <span id="count">0</span> star(s)
                                                        </div>
                                                <div className="row lead">
                                                    <div id="hearts-existing" className="starrr" data-rating="4"><span className="glyphicon .glyphicon-star-empty glyphicon-star"></span><span className="glyphicon .glyphicon-star-empty glyphicon-star"></span><span className="glyphicon .glyphicon-star-empty glyphicon-star"></span><span className="glyphicon .glyphicon-star-empty glyphicon-star"></span><span className="glyphicon .glyphicon-star-empty glyphicon-star-empty"></span></div>
                                    ...
                                    <div className="panel panel-default">
                                        <div className="panel-heading active" role="tab" id="collapse_listing">
                                            <h4 className="panel-title">
                                            ...
                                            <div className="panel-body">
                                                <div class="widget widget-tags u-shadow">
                                                    ...
                                                    <div class="tag-feed">
                                                        ...
                                                        <div class="tag">
                                                            <a class="tag-link" href="/tag/reactjs/">
                                                                <span class="tag-name">Reactjs</span>
                                                                <span class="tag-count">113</span>
                                                            </a>
                                                        </div>
                                                        <div class="tag">
                                                            <a class="tag-link" href="/tag/chart/">
                                                                <span class="tag-name">Chart</span>
                                                                <span class="tag-count">94</span>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div className="col-xs-12 col-sm-12 col-md-8 col-lg-6">
                                    ...
                                    <div className="card_header">
                                        <div className="row header_row">
                                            <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                <InnerSearchBar params={params} handleSearch={handleSearch}/>
                                                <button>Add Blogs</button>
                                            </div>
                                            <div className="col-lg-3 col-md-3 col-sm-6 col-xs-6"></div>
                                            <div className="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                                                {/* <ul onMouseEnter={onClickdropdown} onMouseLeave={onClickdropdown} className="blog_shortBy m-r--5">
                                                        <b className="shortBy" >Short By:</b>
                                                        <li class={`blogShortBy_dropdown ${dropdown ? '' : 'hidden'}`}>
                                                            <ul className="">
                                                                <li className="short-by-dropdown-li" data-value="latest"><a href="">Latest</a>
                                                                </li>
                                                                <li className="short-by-dropdown-li" data-value="oldest"><a href="javascript:void(0);">Oldest</a>
                                                                </li>
                                                                <li className="short-by-dropdown-li" data-value="most_rated"><a href="javascript:void(0);">Most Rated</a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                    </ul> */}
                            ...
                            <div>
                                {
                                    mode === "offline" && <div>You are in offline mode</div>
                                }
                            </div>
                            <div id="all_blogs" className="card">

                                {blogs && blogs.length > 0 &&
                                    blogs.map((blog, index) => {
                                        if (blogs.length === index + 1) {
                                            return (<Post props={blog} onClickShare={onClickShare} setModalOpen={setModalOpen} lastBlogElementRef={lastBlogElementRef} />);
                                        } else {
                                            return (<Post props={blog} onClickShare={onClickShare} setModalOpen={setModalOpen} />);
                                        }
                                    })
                                }
                                {loading &&
                                    ...
                                    <div className="modal-body">
                                        <div id="button_share">
                                            <div className="share_buttons_wrap">
                                                ...
                                                <div className="socialShareButtonItem">
                                                    <a id="reddit" href="http://reddit.com/submit?url=https://www.bestdivision.com/blogs/kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk&amp;title=kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk" target="_blank" rel="nofollow">
                                                        <div className="socialItem">
                                                            <div className="socialItem_icon">
                                                                {/* <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 192 192" style=" fill:#000000;">
                                                                <g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal">
                    ...
                    <div className="pagination">
                        <ul className="pagination">&nbsp;
                            ...
                            <a href="https://www.bestdivision.com/blogs?q=&amp;start=5" className="page-link" data-ci-pagination-page="2">2</a><a href="https://www.bestdivision.com/blogs?q=&amp;start=10" className="page-link" data-ci-pagination-page="3">3</a><a href="https://www.bestdivision.com/blogs?q=&amp;start=5" className="page-link" data-ci-pagination-page="2" rel="next">Next</a>
                            <a href="https://www.bestdivision.com/blogs?q=&amp;start=45" className="page-link" data-ci-pagination-page="10">Last ›</a>
                        </ul>
                    </div>
                </div> */}
                </div>
                <div className="col-xs-12 col-sm-12 col-md-8 col-lg-3"></div>
            </div>
        </section>
    )
}
