            ...
            <div className="panel panel-default panel-post">
                <div className="panel-heading">
                    <div className="media">
                        <div className="media-left">
                            <a href="#">
                                <Svg className="hello" svg={props.brand_logo} />
                                {/* {props.brand_logo} */}
                                {/* <img width="42" height="42" src={`${props.brand_logo}`} /> */}
                            </a>
                        </div>
                ...
                <div className="panel-body">
                    <div className="post">
                        <div className="post-heading">
                            <h2 className="post-title"><Link to={`/tutorials/${props.slug}`}>{props.name}</Link></h2>
                ...
                <div className="panel-footer">
                    ...
                    <div className="panelFooter_row panelFooter_rowTwo" >
                        ...
                        <div className="panelFooter_row_row" >
                            <a onClick={onClickShare} className="share_button" data-toggle="modal" data-target="#sharepost" data-url={`${process.env.REACT_APP_BASE_URL}/tutorials/how-to-make-simple-rest-api-in-codeignter`} data-title="How to make simple REST API in Codeignter.">
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">
