                                            ...
                                            <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                <form className="job-search p-3" autoComplete="off">
                                                    <div className="input-group autocomplete">
                                                        <input value={params.q} onChange={handleSearch} id="search_blogs" className="search_input" type="text" name="search_blogs" placeholder="Search" aria-label="Search" aria-describedby="basic-addon2" />
