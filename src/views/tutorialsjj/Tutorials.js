...
function Tutorials() {
    ...
    useEffect(() => {
        if (isMobile) {
            if (isLeftNavOpen) {
                typeof document !== 'undefined' && document.querySelector('html').classList.add('scroll-lock');
            } else {
                typeof document !== 'undefined' && document.querySelector('html')?.classList?.remove('scroll-lock');
            }
        }
    }, [isLeftNavOpen])
                        ...
                        <div class="row clearfix">
                            ...
                            <div id="" class={isLeftNavOpen ? `col-xs-12 col-sm-12 col-md-8 col-lg-8` : `col-xs-12 col-sm-12 col-md-8 col-lg-10`}>
                                ...
                                <div class="previous_next_container-top">
                                    ...
                                    <a title="Simple Html Page" href={`${process.env.REACT_APP_BASE_URL}/tutorial/html/how-to-backup-your-sql-database-automatically-using-cron-jobs" class="btn btn-danger float-right`}>Next &gt;&gt;</a>
                                </div>
