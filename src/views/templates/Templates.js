                ...
                <div className="container-fluid">
                    <div className="row clearfix">
                        ...
                        <div className="col-xs-12 col-sm-12 col-md-8 col-lg-6">
                                    ...
                                    <div className="card_header">
                                        <div className="row header_row">
                                            ...
                                            <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                <form className="job-search p-3" autoComplete="off" action="/action_page.php">
                                                    <div className="input-group autocomplete">
                                                        <input value={query} onChange={handleSearch} id="search_templates" className="search_input" type="text" name="search_templates" placeholder="Search" aria-label="Search" aria-describedby="basic-addon2" />
                                            ...
                                            <div className="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                                                {/* <ul onMouseEnter={onClickdropdown} onMouseLeave={onClickdropdown} className="template_shortBy m-r--5">
                                                        <b className="shortBy" >Short By:</b>
                                                        <li class={`templateShortBy_dropdown ${dropdown ? '' : 'hidden'}`}>
                                                            <ul className="">
                            ...
                            <div id="all_templates" className="card">
                                {templates && templates.length > 0 &&
                                    templates.map((template, index) => {
                                        if (templates.length === index + 1) {
                                            return (<Post props={template} onClickShare={onClickShare} setModalOpen={setModalOpen} lastTemplateElementRef={lastTemplateElementRef} />);
                                        } else {
                                            return (<Post props={template} onClickShare={onClickShare} setModalOpen={setModalOpen} />);
                                        }
                                    })
                                }
                                {loading &&
