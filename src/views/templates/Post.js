            ...
            <div className="panel panel-default panel-post">
                ...
                <div className="panel-footer">
                    ...
                    <div className="panelFooter_row panelFooter_rowTwo" >
                        ...
                        <div className="panelFooter_row_row" >
                            <a onClick={onClickShare} className="share_button" data-toggle="modal" data-target="#sharepost" data-url={`${process.env.REACT_APP_BASE_URL}/blog/how-to-make-simple-rest-api-in-codeignter`} data-title="How to make simple REST API in Codeignter.">
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">
